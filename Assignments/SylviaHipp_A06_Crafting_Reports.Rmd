...
*Note: I had issues rendering the expression for the y-labels. See Markdown file for intended expression.*

```{r boxplot.2018, echo=FALSE, warning=FALSE, fig.cap = "2018 Monthly Ozone Levels", fig.align='left', out.height="40%", fig.width=9}
...
```{r boxplot.2019, echo=FALSE, warning=FALSE, fig.cap = "2019 Monthly Ozone Levels", fig.align='left', out.height="40%", fig.width=9}
...
df_boxplot %>% 
  ...
  ggplot(aes(x = month, y = Ozone)) + 
  geom_boxplot() + 
  ylab(label = expression(paste("Concentration (", mu, "g/", m^{3}, ")"))) + 
  labs(x = "Month", 
...
https://github.com/sylviahipp/EDE_Fall2025
