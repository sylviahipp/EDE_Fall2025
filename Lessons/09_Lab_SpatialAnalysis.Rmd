...
#library(arcgis)  # doesnt work on R container
...
sea_turtles <- read_sf(data_source)
...
data_source_bus <- paste0(
  "https://services2.arcgis.com/G5vR3cOjh6g2Ed8E/arcgis/rest/services/",
  "PublicTransit/FeatureServer/1/query?outFields=*&where=1%3D1&f=geojson")

bus_routes <- read_sf(data_source_bus)

mapview(bus_routes, zcol = "line_name")
