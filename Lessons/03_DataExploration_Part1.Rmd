...
> Answer: It outputs any conflicts the package might have with other packages already loaded.
...
```{r Setup}
# typically include this chuck together at top of script
...
> ANSWER: README file is found under Data/Metadata within the home directory. Includes context for the data collection and information about from where and when the data was retrieved. Also includes information on the fields included in the dataset.  
...
> Answer: Some were read in as NAs, others were read in as blanks. The blanks represent missing data in factor fields.
...
mean(USGS.flow.data$discharge.mean)  # will return NA if any NA values are included
...
create.early.dates <- (function(d) {
       paste0(ifelse(d > 191226,"19","20"),d)  # if year is between 00 and 19, assign to 2000, otherwise 1900
       })
#
