...
```{r}
cars$speed  # extracts the speed column as a vector
```
...
```{r}
#Option 1
class(car_speed)   # this is a vector
...
#Option 1
# you are able to bind on a vector to the data frame as a column
...
# can also bind together two data frames as long as they're the same length
