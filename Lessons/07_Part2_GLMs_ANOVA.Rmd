...
# reject null: means across the groups are different

summary(Litter$functionalGroup) # 7 df
summary(Litter$nlcdClass)       # 2 df
...
# factor object with levels being 24 possible combinations, observation for each row in Litter 
